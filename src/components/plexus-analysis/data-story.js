            ...
            <ContentWrapper>
                <div className="content-block">
                    <div className="content-wrapper__desc-wrapper">
                        ...
                        <div className="content-wrapper__desc-wrapper__desc content-wrapper__desc-wrapper__desc--center">
                            <p>Insert a detailed description of Transport Desirability here. Baguio is ranked 130th of 200 cities in the Philippines based on Transport Desirability.</p>
                        </div>
                    </div>
                    <VisRow>
                        {/* <BarChart
                ...
                <div className="content-block content-block--dark">
                    <div className="content-wrapper__desc-wrapper">
                        ...
                        <div className="content-wrapper__desc-wrapper__desc content-wrapper__desc-wrapper__desc--center">
                        <p>The next two sections highlight the best features of the city's transport system.Insert a detailed description of Transport Desirability here. Baguio is ranked 130th of 200 cities in the Philippines based on Transport Desirability.</p>
                  </div>
                    </div>
                    ...
                    <div className="content-wrapper__desc-wrapper">
                        ...
                        <div className="content-wrapper__desc-wrapper__desc">
                            {/* Insert a detailed description of the Physiological indicator here. What constitutes its score? What does it mean if it's good? If it's bad? How can I improve it? */}
                            Sustainability indicator considers energy use, health cost, and greenhouse gas social cost of per transport mode in the area. When the score of the barangay is low, available transport modes in that area are less eco-friendly and may cause harmful effects to residents’ health and the environment.
                  </div>
                    </div>
                ...
                <div className="content-wrapper__desc-wrapper">
                  ...
                  /> */}
                    ...
                    <div className="content-wrapper__desc-wrapper">
                        ...
                        <div className="content-wrapper__desc-wrapper__desc">
                        Psychological indicator considers <b>security, accidents, and privacy</b> of per transport mode in that area. When the score of the barangay is low, the barangay may lack security and privacy in its available transport modes. Also, these transport modes may be accident prone.
                        ...
                        <VisRow>
                            ...
                            />
                            <DescriptionBlock>
                            The people of Baguio predominantly use <b>jeeps</b> in their daily traveling, having a <b>56.69%</b> transport mode share in the city. The <b>relatively low security, high susceptibility to accidents, and low privacy</b> of <b>jeeps</b> may have largely contributed to the low Psychological indicator score.
                            </DescriptionBlock>
                        </VisRow>
                    </div>
